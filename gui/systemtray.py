...
class TaskSystemTrayIcon(QtGui.QSystemTrayIcon):
    ...
    def _createTrayActions(self):
        self.refreshAction = QtGui.QAction(self.tr('Refresh'), self, triggered=self.refreshClick)
        self.quitAction = QtGui.QAction(self.tr('Quit'), self, triggered=QtGui.qApp.quit)
